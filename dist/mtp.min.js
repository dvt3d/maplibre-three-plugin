(() => {
  ...
  var MapScene = class {
    constructor(map, options = {}) {
      ...
      this._scene = this._options.scene || new import_three2.Scene();
      this._camera = this._options.camera || new import_three2.PerspectiveCamera(
      ...
      this._renderer = this._options.renderer || new import_three2.WebGLRenderer({
        alpha: true,
        antialias: true,
      ...
      this._lights = new import_three2.Group();
      this._lights.name = "lights";
      this._scene.add(this._lights);
      this._world = new import_three2.Group();
      ...
      this._event = new import_three2.EventDispatcher();
    }
    get map() {
      return this._map;
    }
  ...
  var SceneTransform = class {
    ...
    static lngLatToVector3(lng, lat, alt = 0) {
      ...
      return new import_three3.Vector3(v[0], v[1], v[2]);
    }
    /**
     *
     * @param v
  ...
  var Creator = class {
    ...
    static createShadowGround(center, width = 100, height = 100) {
      const geo = new import_three4.PlaneGeometry(width, height);
      const mat = new import_three4.ShadowMaterial({
        opacity: 0.5,
        transparent: true
      });
      let mesh = new import_three4.Mesh(geo, mat);
